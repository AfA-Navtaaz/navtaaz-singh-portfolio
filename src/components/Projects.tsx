...
const projects = [
  {
    ...
    description: "Applied decision analysis techniques including AHP, decision trees, and fault trees to evaluate wastewater treatment alternatives. Implemented Monte Carlo reliability simulation for uncertainty analysis.",
    icon: Droplets,
    tags: ["AHP", "Decision Trees", "Fault Trees", "Monte Carlo", "EVPI"],
    color: "accent",
  },
  {
    id: "mfvrp-lez",
    title: "MFVRP-LEZ: Mixed Fleet Vehicle Routing Problem",
    description: "Reimplemented MILP optimization model for mixed electric and conventional vehicle fleets with Low Emission Zone considerations. Solved using Python, Pyomo, Gurobi, and CBC solvers.",
    icon: Truck,
  ...
  },
  {
    ...
    description: "Designed and implemented a sensor-based agricultural monitoring system for real-time data acquisition, analytics, and automated reporting.",
    icon: TreeDeciduous,
    tags: ["IoT", "Sensors", "Data Analytics", "Agriculture"],
    color: "primary",
  },
  {
    id: "rack-room-humidity",
    title: "Rack Room Humidity Monitoring",
    description: "Implemented environmental risk monitoring system for electrical and PLC rooms, focusing on reliability and preventive maintenance strategies.",
    icon: ThermometerSun,
    tags: ["Environmental Monitoring", "Reliability", "Preventive Maintenance"],
    color: "accent",
  },
];
